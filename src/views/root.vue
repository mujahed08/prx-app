<template>
    <ul class="nav border-bottom">
        <li class="nav-item">
            <router-link to="/" active-class="active fw-bolder" class="nav-link">Home</router-link>
        </li>
        <li class="nav-item">
            <router-link to="/patient/list/1" active-class="active fw-bolder" class="nav-link">Patient List</router-link>
        </li>
        <li class="nav-item">
